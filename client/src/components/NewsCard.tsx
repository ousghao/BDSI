...
export function NewsCard({ article, variant = "horizontal" }: NewsCardProps) {
  ...
  if (variant === "vertical") {
    return (
      <Card 
        className="bg-slate-50 dark:bg-slate-700 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group"
  ...
  return (
    <article className="group" data-testid={`news-article-${article.id}`}>
